...
///Block(global)
func setupBox(log logrus.FieldLogger) func(c *cli.Context) error {
	return func(c *cli.Context) error {
		...
		_, err = box.EnsureBoxWithOptions(c.Context, box.WithLogger(log), box.WithMinVersion(1))
		return err
	}
}
...
func main() {
	...
	app := cli.App{
		...
		Name:    "devenv",
		///Block(app)
		Description:          cmdutil.Normalize("devenv manages your Outreach developer environment"),
